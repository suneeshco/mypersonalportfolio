      ...
      function validateForm() {
        ...
        if (mobilenumber == "") {
          msg1.innerHTML = "Mobile Number cannot be blank"
          setTimeout(function(){
                  msg1.innerHTML = ""
                },5000)
          return false;
        ...
        if (!emailRegex.test(email)) {
          msg1.innerHTML = "Enter a valid email address"
          setTimeout(function(){
                  msg1.innerHTML = ""
                },5000)
          return false;
        ...
        if (subject == "") {
          msg1.innerHTML = "Subject cannot be blank"
          setTimeout(function(){
                  msg1.innerHTML = ""
                },5000)
          return false;
        ...
        if (message == "") {
          msg1.innerHTML = "Message cannot be blank"
          setTimeout(function(){
                  msg1.innerHTML = ""
                },5000)
          return false;
